...
public:
   ...
   enum Use {Mash, First_Wort, Boil, UseAroma, Dry_Hop, Whirlpool}; // NOTE: way bad. We have a duplicate enum (Aroma), and BeerXML expects a space for "Dry Hop" and "First Wort". Damn. Damn damn.
