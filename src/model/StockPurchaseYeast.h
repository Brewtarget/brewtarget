/*======================================================================================================================
 * model/StockPurchaseYeast.h is part of Brewtarget, and is copyright the following authors 2023-2025:
 ...
 * <http://www.gnu.org/licenses/>.
 =====================================================================================================================*/
#ifndef MODEL_STOCKPURCHASEYEAST_H
#define MODEL_STOCKPURCHASEYEAST_H
#pragma once
...
#define AddPropertyName(property) namespace PropertyNames::StockPurchaseYeast { inline BtStringConst const property{#property}; }
...
/**
 * \brief StockPurchase of \c Yeast
 */
class StockPurchaseYeast : public StockPurchase,
                       public IngredientAmount<StockPurchaseYeast, Yeast>,
                       public StockPurchaseBase   <StockPurchaseYeast, Yeast, StockUseYeast> {
   Q_OBJECT

   INGREDIENT_AMOUNT_DECL(StockPurchaseYeast, Yeast)
   STOCK_PURCHASE_DECL(Yeast, yeast)
