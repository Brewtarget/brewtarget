...
TypeLookup const Style::typeLookup {
   "Style",
   {
      ...
      PROPERTY_TYPE_LOOKUP_ENTRY(Style, ogMin            , m_ogMin            , Measurement::PhysicalQuantity::Gravity    ),
      PROPERTY_TYPE_LOOKUP_ENTRY(Style, ogMax            , m_ogMax            , Measurement::PhysicalQuantity::Gravity    ),
      PROPERTY_TYPE_LOOKUP_ENTRY(Style, fgMin            , m_fgMin            , Measurement::PhysicalQuantity::Gravity    ),
      PROPERTY_TYPE_LOOKUP_ENTRY(Style, fgMax            , m_fgMax            , Measurement::PhysicalQuantity::Gravity    ),
