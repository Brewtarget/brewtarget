/*
 * xml/BeerXmlYeastRecordLoader.h is part of Brewtarget, and is Copyright the following
 * authors 2020-2021
 ...
 */
#ifndef _XML_BEERXMLYEASTRECORDLOADER_H
#define _XML_BEERXMLYEASTRECORDLOADER_H
#pragma once
