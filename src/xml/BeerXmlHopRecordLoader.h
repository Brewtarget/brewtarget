/*
 * xml/BeerXmlHopRecordLoader.h is part of Brewtarget, and is Copyright the following
 * authors 2020-2021
 ...
 */
#ifndef _XML_BEERXMLHOPRECORDLOADER_H
#define _XML_BEERXMLHOPRECORDLOADER_H
#pragma once
