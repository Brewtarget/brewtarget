...
MashStepEditor::MashStepEditor(QWidget* parent, QString const editorName) :
   ...
   this->postSetupUiInit({
      ...
      EDITOR_FIELD_NORM(MashStep, label_stepTemp    , lineEdit_stepTemp    , Step::startTemp_c               , 1),
      EDITOR_FIELD_NORM(MashStep, label_stepTime    , lineEdit_stepTime    , Step::stepTime_mins             , 0),
      EDITOR_FIELD_NORM(MashStep, label_rampTime    , lineEdit_rampTime    , Step::rampTime_mins             , 0),
