...
public:
   ...
   struct TableField {
      ...
      BtStringConst                propertyName; // Can be empty in a junction table (see below)
      using ValueDecoder =
...
signals:
    ...
    *        objects of this type should connect this signal to a slot.
    *
   ...
   /**
    * \brief Signal emitted when an object is deleted.
    *
