...
///COLUMN_INFOS(
///   TreeFolderNode<Hop>,
///   TREE_NODE_HEADER(TreeFolderNode, Hop, Name    , tr("Name"     ), PropertyNames::NamedEntity::name),
///   TREE_NODE_HEADER(TreeFolderNode, Hop, Path    , tr("Path"     ), PropertyNames::Folder::path    ),
///   TREE_NODE_HEADER(TreeFolderNode, Hop, FullPath, tr("Full Path"), PropertyNames::Folder::fullPath),
///)
///
...
template<> EnumStringMapping const TreeItemNode<Style>::columnDisplayNames {
   ...
   {TreeItemNode<Style>::ColumnIndex::StyleLetter   , Style::tr("Letter"  )},
