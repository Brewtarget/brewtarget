...
TREE_SORT_FILTER_PROXY_MODEL_COMMON_CODE(Boil                )
TREE_SORT_FILTER_PROXY_MODEL_COMMON_CODE(Equipment           )
TREE_SORT_FILTER_PROXY_MODEL_COMMON_CODE(Fermentable         )
TREE_SORT_FILTER_PROXY_MODEL_COMMON_CODE(Fermentation        )
TREE_SORT_FILTER_PROXY_MODEL_COMMON_CODE(Hop                 )
TREE_SORT_FILTER_PROXY_MODEL_COMMON_CODE(StockPurchaseFermentable)
TREE_SORT_FILTER_PROXY_MODEL_COMMON_CODE(StockPurchaseHop        )
TREE_SORT_FILTER_PROXY_MODEL_COMMON_CODE(StockPurchaseMisc       )
TREE_SORT_FILTER_PROXY_MODEL_COMMON_CODE(StockPurchaseSalt       )
