/*======================================================================================================================
 * qtModels/sortFilterProxyModels/SaltSortFilterProxyModel.cpp is part of Brewtarget, and is copyright the following
 * authors 2025:
...
bool SaltSortFilterProxyModel::isLessThan(SaltTableModel::ColumnIndex const columnIndex,
                                          QVariant const & leftItem,
                                          QVariant const & rightItem) const {
   switch (columnIndex) {
      case SaltTableModel::ColumnIndex::Name:
      case SaltTableModel::ColumnIndex::Type:
