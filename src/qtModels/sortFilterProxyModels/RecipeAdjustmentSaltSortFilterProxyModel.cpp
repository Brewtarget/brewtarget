/*======================================================================================================================
 * qtModels/sortFilterProxyModels/RecipeAdjustmentSaltSortFilterProxyModel.cpp is part of Brewtarget, and is copyright the following
 * authors 2025:
...
bool RecipeAdjustmentSaltSortFilterProxyModel::isLessThan(RecipeAdjustmentSaltTableModel::ColumnIndex const columnIndex,
   ...
   switch (columnIndex) {
      ...
      case RecipeAdjustmentSaltTableModel::ColumnIndex::AddTo:
         return RecipeAdjustmentSalt::whenToAddDisplayNames.stringToEnumAsInt( leftItem.toString()) <
                RecipeAdjustmentSalt::whenToAddDisplayNames.stringToEnumAsInt(rightItem.toString());
