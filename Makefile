...
# Generated by qmake (2.01a) (Qt 4.4.0) on: Wed Jan 7 20:20:19 2009
# Project:  TableWidget.pro
# Template: app
# Command: /usr/bin/qmake -unix -o Makefile TableWidget.pro
#############################################################################
...
Makefile: TableWidget.pro  /usr/share/qt4/mkspecs/linux-g++/qmake.conf /usr/share/qt4/mkspecs/common/g++.conf \
		/usr/share/qt4/mkspecs/common/unix.conf \
		/usr/share/qt4/mkspecs/common/linux.conf \
		/usr/share/qt4/mkspecs/qconfig.pri \
		/usr/share/qt4/mkspecs/features/qt_functions.prf \
	...
	$(QMAKE) -unix -o Makefile TableWidget.pro
...
dist: 
	...
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/tabletest1.0.0/ && $(COPY_FILE) --parents FermentableTableWidget.h FermentableTableModel.h HopTableWidget.h HopTableModel.h MiscTableWidget.h MiscTableModel.h fermentable.h hop.h misc.h observable.h xmlnode.h stringparsing.h xml.h xmltree.h .tmp/tabletest1.0.0/ && $(COPY_FILE) --parents tabletest.cpp FermentableTableWidget.cpp FermentableTableModel.cpp HopTableWidget.cpp HopTableModel.cpp MiscTableWidget.cpp MiscTableModel.cpp fermentable.cpp hop.cpp misc.cpp observable.cpp observer.cpp xmlnode.cpp stringparsing.cpp xml.cpp xmltree.cpp .tmp/tabletest1.0.0/ && (cd `dirname .tmp/tabletest1.0.0` && $(TAR) tabletest1.0.0.tar tabletest1.0.0 && $(COMPRESS) tabletest1.0.0.tar) && $(MOVE) `dirname .tmp/tabletest1.0.0`/tabletest1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/tabletest1.0.0
...
compiler_moc_header_make_all: moc_FermentableTableWidget.cpp moc_FermentableTableModel.cpp moc_HopTableWidget.cpp moc_HopTableModel.cpp moc_MiscTableWidget.cpp moc_MiscTableModel.cpp
compiler_moc_header_clean:
	-$(DEL_FILE) moc_FermentableTableWidget.cpp moc_FermentableTableModel.cpp moc_HopTableWidget.cpp moc_HopTableModel.cpp moc_MiscTableWidget.cpp moc_MiscTableModel.cpp
...
tabletest.o: tabletest.cpp MiscTableWidget.h \
		MiscTableModel.h \
		misc.h \
		xmlnode.h \
		observable.h \
